...
### Ask for SLA accept
### ACIS-Archer - Some statements commented out and some statements added

def check_sla_accept():
    # called for licenses that require run-time accept of the SLA
# ACIS-Archer - print message was was added
    print "The user is deemed to have read and complied with the SLA at http://www.grid-appliance.org/files/archer/tutorials/simics/NON_COMMERCIAL_SLA "
# ACIS-Archer - Next 2 lines commented
    #license_ack = read_global_prefs('sla-accepted')
    #if license_ack:
    conf.sim.gui_ready = 2
    return
# ACIS-Archer - Next 4 lines commented
...
# ACIS-Archer - Next line added
	accept = 'yes'
# ACIS-Archer - Next line commented
